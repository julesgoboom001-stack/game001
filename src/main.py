import pygame
from game_states import StateManager, CharacterSelection, Gameplay, LevelUp, Inventory, Crafting, ElementSelection
...
def main():
    ...
    element_selection_state = ElementSelection(state_manager)

    # Add states to the manager
    state_manager.add_state("CHARACTER_SELECTION", character_selection_state)
    state_manager.add_state("ELEMENT_SELECTION", element_selection_state)
